...
public class Funcion {
    ...
    public Funcion(Integer idFuncion, String fechaFuncion, String horaFuncion, Double precioFuncion, Pelicula peliculaFuncion, Sala salaFuncion, Short cantidadBoletasFuncion) {
    ...
    public String toString() {
        return "Funcion{" + "idFuncion=" + idFuncion + ", fechaFuncion=" + fechaFuncion + ", horaFuncion=" + horaFuncion + ", precioFuncion=" + precioFuncion + ", peliculaFuncion=" + peliculaFuncion + ", salaFuncion=" + salaFuncion + ", cantidadBoletasFuncion=" + cantidadBoletasFuncion + '}';
    }
