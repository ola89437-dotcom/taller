...
public class Sala {
    ...
    public Sala(Integer idSala, String nombreSala, Short capacidadSala, Short cantidadFuncionesSala) {
        this.idSala = idSala;
    ...
    public String toString() {
        return "sala{" + "idSala=" + idSala + ", nombreSala=" + nombreSala + ", capacidadSala=" + capacidadSala + ", cantidadFuncionesSala=" + cantidadFuncionesSala + '}';
    }
