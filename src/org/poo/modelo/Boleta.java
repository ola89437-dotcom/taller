...
public class Boleta {
   ...
   public Boleta() {
        ...
        public Boleta(Integer idBoleta, String numeroAsientoBoleta, String fechaCompraBoleta, Funcion funcionBoleta, Cliente clienteBoleta, Boolean estadoBoleta) {
    ...
    public String toString() {
        return "Boleta{" + "idBoleta=" + idBoleta + ", numeroAsientoBoleta=" + numeroAsientoBoleta + ", fechaCompraBoleta=" + fechaCompraBoleta + ", funcionBoleta=" + funcionBoleta + ", clienteBoleta=" + clienteBoleta + ", estadoBoleta=" + estadoBoleta + '}';
    }
