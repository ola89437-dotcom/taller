...
public class DirectorDto {
    ...
    public DirectorDto(Integer idDirector, String nombreDirector, String nacionalidadDirector, Short cantidadPeliculasDirector, String nombreImagenPublicoDirector, String nombreImagenPrivadoDirector) {
    ...
    public String toString() {
        return "DirectorDto{" + "idDirector=" + idDirector + ", nombreDirector=" + nombreDirector + ", nacionalidadDirector=" + nacionalidadDirector + ", cantidadPeliculasDirector=" + cantidadPeliculasDirector + ", nombreImagenPublicoDirector=" + nombreImagenPublicoDirector + ", nombreImagenPrivadoDirector=" + nombreImagenPrivadoDirector + '}';
    }
